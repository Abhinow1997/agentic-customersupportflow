<script>
  ...
  let streamError = '';
  let stages = [];        // { stage, agent, status: 'running'|'complete', output }
  let warnings = [];
  ...
  <div class="content-grid">
    ...
    <div class="output-panel">
      ...
      {:else}
        ...
        <!-- ── Generated Posts (hero — shown when complete) ── -->
        {#if hasPosts}
                ...
                <div class="post-card">
                  ...
                  <div class="post-footer">
                    <div class="post-visual">
                      <span class="footer-label">📸 Visual</span>
        ...
        {#if finalResult}
          <details class="campaign-details" open>
            ...
            <div class="details-body">
              ...
              {#if finalResult.visualizerPrompt}
                <div class="detail-block">
                  <div class="detail-key">Visualizer Prompt</div>
                  <p class="detail-text italic">{finalResult.visualizerPrompt}</p>
                </div>
              {/if}
        ...
        {#if hasPipeline}
          <div class="pipeline-section">
            ...
            <div class="timeline">
              {#each stages as s, i}
                <div class="tl-row" class:tl-running={s.status === 'running'} class:tl-done={s.status === 'complete'}>
                  <!-- Icon track -->
                  <div class="tl-track">
                    <div class="tl-icon">
                      {#if s.status === 'running'}
...
<style>
  ...
  .tag-pill {
    ...
    border: 1px solid rgba(91,140,240,0.3);
    border-radius: 999px;
    padding: 2px 8px;
    font-family: var(--font-mono);
  }
  ...
  .footer-label { color: var(--text-muted); flex-shrink: 0; }
  ...
  .detail-text.italic { font-style: italic; }
  ...
  @media (max-width: 640px) {
    ...
    .content-grid { padding: 14px 16px 20px; gap: 12px; }
