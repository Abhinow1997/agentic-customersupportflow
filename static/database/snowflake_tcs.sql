-- TPC-DS v2.5.0 Complete Schema with CREATE TABLE Statements for Snowflake
-- 7 Fact Tables + 17 Dimension Tables = 24 tables total

-- =====================================================================
-- FACT TABLES (7)
-- =====================================================================

-- 1. STORE SALES (SS) - Store Channel Sales
...
-- =====================================================================
-- OPTIONAL: DSDGEN VERSION TABLE
-- =====================================================================

-- 25. DSDGEN VERSION (DV) - Not used in benchmark but useful for tracking
CREATE TABLE IF NOT EXISTS dsdgen_version (
